...
//
//import static org.firstinspires.ftc.teamcode.AAAOpModes.BaseOpMode.hardware;
...
//        fl.setDirection(DcMotorEx.Direction.REVERSE); // add if needed
//        bl.setDirection(DcMotorEx.Direction.REVERSE); // add if needed
//

...
import static org.firstinspires.ftc.teamcode.AAAOpModes.Autonomous.Paths.Path.MTPath3;
import static org.firstinspires.ftc.teamcode.AAAOpModes.Autonomous.Paths.Path.MTPath4;
import static org.firstinspires.ftc.teamcode.AAAOpModes.Autonomous.Paths.Path.MTPath5;
...
//            drive.update();
    ...
    private boolean summercamppaths(){
        switch (pathNumber) {
            case 1:
                telemetry.addLine("Following Path 1");

                return !drive.followPath(Path1, power, 0, 0, true);
            case 2:
                telemetry.addLine("Following Path 2");

                return !drive.followPath(Path2, power, 0, 0, true);
            case 3:
                telemetry.addLine("Following Path 3");

                return !drive.followPath(Path3, power, 0, 0, true);
            case 4:
                telemetry.addLine("Following Path 4");

                return !drive.followPath(Path4, power, 0, 0, true);
            case 5:
                telemetry.addLine("Following Path 5");

                return !drive.followPath(Path5, power, 0, 0, true);
            case 6:
                telemetry.addLine("Following Path 6");

                return !drive.followPath(Path6, power, 0, 0, true);
            case 7:
                telemetry.addLine("Following Path 4");

                return !drive.followPath(Path7, power, 0, 0, true);
            case 8:
                telemetry.addLine("Following Path 5");

                return !drive.followPath(Path8, power, 0, 0, true);
            case 9:
                telemetry.addLine("Following Path 6");

                return !drive.followPath(Path9, power, 0, 0, true);
